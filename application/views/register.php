                    ...
                    <div class="col-12">
                        <div class="card m-b-20">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Tambah Pegawai</h4>
                                <p class="text-muted m-b-30 ">Silahkan masukkan informasi data diri anda sebagai pegawai.</p>
                                ...
                                <div class="form-group row">
                                    <label for="id-card" class="col-sm-2 col-form-label">No KTP</label>
                                    <div class="col-sm-10">
                                ...
                                <p class="text-muted m-b-30 m-t-30 ">Riwayat Pendidikan</p>
                                <div class="form-group row">
                                    <label for="sd" class="col-sm-2 col-form-label">SD</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="sd">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="smp" class="col-sm-2 col-form-label">SMP</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="smp">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="sma" class="col-sm-2 col-form-label">SMA</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="sma">
                                    </div>
                                </div>
                                <div class="form-group row">
