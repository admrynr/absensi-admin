                                ...
                                <div class="inbox-wid">
                                    <a href="#" class="text-dark">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url('assets/images/users/user-1.jpg')?>" class="thumb-md rounded-circle" alt=""></div>
                                    ...
                                    <a href="#" class="text-dark">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url('assets/images/users/user-2.jpg')?>" class="thumb-md rounded-circle" alt=""></div>
                                    ...
                                    <a href="#" class="text-dark">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url('assets/images/users/user-3.jpg')?>" class="thumb-md rounded-circle" alt=""></div>
                                    ...
                                    <a href="#" class="text-dark">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url('assets/images/users/user-4.jpg')?>" class="thumb-md rounded-circle" alt=""></div>
                                    ...
                                    <a href="#" class="text-dark">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url('assets/images/users/user-5.jpg')?>" class="thumb-md rounded-circle" alt=""></div>
                                    ...
                                    <a href="#" class="text-dark">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url('assets/images/users/user-6.jpg')?>" class="thumb-md rounded-circle" alt=""></div>
